...
describe("BookList", () => {
  it("renders empty state message when books is empty", async () => {
    render(<BookList books={{}} onEdit={() => {}} onDelete={() => {}} onStatusChange={() => {}} />);
  ...
  it("renders one BookCard per book in the record", async () => {
    ...
    render(
      <BookList books={books} onEdit={() => {}} onDelete={() => {}} onStatusChange={() => {}} />,
    );
  ...
  it("passes onEdit callback through to BookCard", async () => {
    ...
    render(
      <BookList books={books} onEdit={onEdit} onDelete={() => {}} onStatusChange={() => {}} />,
    );
  ...
  it("passes onDelete callback through to BookCard", async () => {
    ...
    render(
      <BookList books={books} onEdit={() => {}} onDelete={onDelete} onStatusChange={() => {}} />,
    );
