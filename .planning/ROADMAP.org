...
- [ ] 02-01-PLAN.md — Tidy-up + ADR-0006 (Playwright E2E) + ADR-0007 (XState) + ADR-0008 (storage.local) [Wave 1]
- [ ] 02-02-PLAN.md — Vite extension scaffold: manifest, build pipeline, minimal React app [Wave 2]
- [ ] 02-03-PLAN.md — Data schema + storage layer with TDD (TanStack Query) [Wave 2]
- [ ] 02-04-PLAN.md — XState v5 app machine with TDD + React wiring [Wave 3]
- [ ] 02-05-PLAN.md — Storybook setup + first story + Playwright E2E smoke test [Wave 4]
