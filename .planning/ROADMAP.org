...
- [X] *Phase 1: Tooling & Practice Foundation* -- ADR infrastructure, Vitest
  + TDD methodology locked in, React/TanStack/Storybook decisions recorded
  before any feature code
- [X] *Phase 2: Extension Scaffold* -- Working Firefox extension shell with
...
- [X] *Phase 4: New Tab Display* -- Current book is shown prominently on every
  new tab; empty and populated states both handled
- [X] *Phase 5: Queue* -- Want-to-read list is visible and annotatable with
  intention notes
- [X] *Phase 6: Data Safety* -- User can export and safely import their
...
Plans:
- [X] 01-01-PLAN.md — ADR infrastructure (docs/decisions/ + MADR template) + CONTRIBUTING.org
- [X] 01-02-PLAN.md — Vitest + React + TanStack configuration (package.json + vitest.config.ts + tsconfig.json)
- [X] 01-03-PLAN.md — ADR-0001 (Vitest) + ADR-0002 (TDD) + ADR-0003 (React) + ADR-0004 (TanStack Query) + ADR-0005 (Storybook)
...
- [X] 02-01-PLAN.md — Tidy-up + ADR-0006 (Playwright E2E) + ADR-0007 (XState) + ADR-0008 (storage.local) [Wave 1]
- [X] 02-02-PLAN.md — Vite extension scaffold: manifest, build pipeline, minimal React app [Wave 2]
- [X] 02-03-PLAN.md — Data schema + storage layer with TDD (TanStack Query) [Wave 2]
- [X] 02-04-PLAN.md — XState v5 app machine with TDD + React wiring [Wave 3]
- [X] 02-05-PLAN.md — Storybook setup + first story + Playwright E2E smoke test [Wave 4]
...
- [ ] 03-01-PLAN.md — Tidy-up + createBookRecord() factory + library XState machine (TDD) [Wave 1]
- [ ] 03-02-PLAN.md — BookForm component for add/edit (TDD, browser tests) [Wave 2]
- [ ] 03-03-PLAN.md — BookCard + BookList components for display/delete/status (TDD, browser tests) [Wave 2]
- [ ] 03-04-PLAN.md — Wire into App.tsx + extend appMachine + Storybook stories + Playwright E2E [Wave 3]
...
- [X] 04-01-PLAN.md — Tidy-up + CurrentlyReading hero component (TDD, browser tests) [Wave 1]
- [X] 04-02-PLAN.md — EmptyHero + QueueCount components (TDD, browser tests) [Wave 1]
- [X] 04-03-PLAN.md — Wire dashboard layout into App.tsx (CurrentlyReading/EmptyHero + QueueCount + BookList) [Wave 2]
- [X] 04-04-PLAN.md — Storybook stories for new components + App dashboard states + Playwright E2E [Wave 2]
...
- [X] 05-01-PLAN.md — Tidy-up + QueueList component (TDD, browser tests) [Wave 1]
- [X] 05-02-PLAN.md — QueueNoteEditor component + BookCard queueNote display (TDD, browser tests) [Wave 1]
- [X] 05-03-PLAN.md — Wire queue into App.tsx + appMachine states + Storybook stories + Playwright E2E [Wave 2]
...
- [X] 06-01-PLAN.md — Tidy-up + ADR-0010 (Versioned JSON export schema) [Wave 1]
- [X] 06-02-PLAN.md — Export/import utility functions with TDD (unit tests) [Wave 1]
- [X] 06-03-PLAN.md — DataManager component with TDD (browser tests) [Wave 2]
- [X] 06-04-PLAN.md — Wire into App.tsx + appMachine + Storybook + Playwright E2E [Wave 2]
...
|-------+-----------------------------+----------------+-------------+-----------|
|     1 | Tooling & Practice          | 3/3            | Complete    | [2026-02-26 Thu] |
|     2 | Extension Scaffold          | 0/?            | Not started | --        |
|     3 | Library CRUD                | 0/?            | Not started | --        |
|     4 | New Tab Display             | 4/4            | Complete    | [2026-02-26 Thu] |
|     5 | Queue                       | 3/3            | Complete    | [2026-02-26 Thu] |
|     6 | Data Safety                 | 4/4            | Complete    | [2026-02-27 Thu] |
...
|---------------------------------------------+---------------------------+---------------|
| Test framework: Vitest (jsdom)              | =0001-vitest.org=         |             1 |
...
| Test env: Vitest browser mode (supersedes 0001) | =0012-vitest-browser-mode.org= |        1 |
